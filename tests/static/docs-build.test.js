...
test('generated documentation is current and keeps public pages separate from technical pages',()=>{
  ...
  for(const route of ['/docs/','/docs/architecture/','/docs/architecture/hld/','/docs/architecture/lld/','/docs/architecture/photo-to-scan/','/docs/architecture/local-ai-models/','/docs/architecture/sheetlocal/','/docs/workflow/agent-collaboration/']){
